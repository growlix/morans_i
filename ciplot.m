function[h] = ciplot(lower,upper,x,colour,transparency)
...
% modified from Raymond Reynolds 24/11/06 file:
...
h = fill([x fliplr(x)],[upper fliplr(lower)],colour,'EdgeColor','none',...
